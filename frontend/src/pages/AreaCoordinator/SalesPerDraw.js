          ...
          <div className="rounded-2xl border bg-white border-gray-100 shadow-medium p-3">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right flex-1 ml-3 min-w-0">
                ...
                <div className="text-base sm:text-lg font-bold text-purple-600 whitespace-nowrap">₱{dailyStats.today.sales.toLocaleString()}</div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  className="px-2.5 sm:px-3 py-1.5 sm:py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-xs sm:text-sm"
                />
              </div>
            </div>
          </div>
                ...
                <ModernCard key={draw.time} className="hover:shadow-lg transition-shadow duration-200">
                  ...
                  <div className="p-4 sm:p-6">
                    <div className="text-center mb-3 sm:mb-4">
                      <div className="text-2xl sm:text-3xl font-bold text-purple-600 overflow-hidden text-ellipsis whitespace-nowrap">
                ...
                return (
                  <div key={draw.time} className="p-3 sm:p-4 lg:p-6">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className={`text-sm font-medium ${netRevenue >= 0 ? 'text-purple-600' : 'text-red-600'}`}>
                    ...
                    <div className="grid grid-cols-2 gap-3 text-xs">
                      ...
                      <div>
                        ...
                        <div className={`font-medium ${netRevenue >= 0 ? 'text-purple-600' : 'text-red-600'}`}>
                          ₱{netRevenue.toLocaleString()}
                        </div>
                      </div>
                    </div>
                ...
                {drawTimes.map((draw) => {
                  ...
                  return (
                    <tr key={draw.time}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        <span className={netRevenue >= 0 ? 'text-purple-600' : 'text-red-600'}>
                          ₱{netRevenue.toLocaleString()}
                        </span>
                      </td>
                    </tr>
