      ...
      <div className="w-full px-2 py-2">
        <div className="mb-2">
          <h1 className="text-lg font-bold text-blue-900 text-center">
            {user.role === 'agent' ? 'My Winners' : 'Winners'}
          </h1>
          <p className="text-xs text-blue-600 text-center">Winning tickets & prizes</p>
        </div>
        ...
        <div className="bg-white rounded p-2 mb-2 border border-blue-200">
          <div className="grid grid-cols-3 gap-1">
            <div className="text-center">
              <div className="text-sm font-bold text-blue-600">{calculateTotalTickets()}</div>
              <div className="text-xs text-blue-600">Winners</div>
            </div>
            <div className="text-center">
              <div className="text-sm font-bold text-blue-600">{formatCurrency(calculateTotalWinnings())}</div>
        ...
        {showFilters && (
          <div className="bg-white rounded-lg p-4 mb-4">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Filter Winning Tickets</h3>
