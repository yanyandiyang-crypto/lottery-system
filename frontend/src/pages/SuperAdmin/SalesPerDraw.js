      ...
      <div className="w-full px-2 sm:px-4 py-4 sm:py-6">
          ...
          <div className="bg-gradient-to-r from-red-50 to-red-100 px-6 py-4 border-b border-gray-200">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
              <div className="flex items-center">
                <CalendarDaysIcon className="h-6 w-6 mr-3 text-red-600" />
                <div>
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  className="px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-red-500 focus:border-blue-500"
                />
              </div>
            </div>
          </div>
        ...
        {salesData.length > 0 && (
          <ModernCard>
            <div className="bg-gradient-to-r from-red-50 to-red-100 px-6 py-4 border-b border-gray-200">
              <div className="flex items-center">
                <ChartBarIcon className="h-6 w-6 mr-3 text-red-600" />
                <div>
