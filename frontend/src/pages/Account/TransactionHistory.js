                  ...
                  >
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <div className="flex items-center space-x-2">
                          ...
                          <span className={`inline-flex items-center px-2 py-1 text-xs font-medium rounded-full ${getTransactionColor(transaction.transaction_type, transaction.status)}`}>
                            {transaction.status}
                          </span>
                        </div>
                    ...
                    <div className="text-right">
                      <div className={`text-lg font-semibold ${
                        transaction.transaction_type === 'load' || transaction.transaction_type === 'refund'
                          ? 'text-green-600'
                          : 'text-red-600'
                      }`}>
