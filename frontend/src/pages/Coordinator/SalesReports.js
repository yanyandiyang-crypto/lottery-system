            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-2.5 py-1.5 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 text-xs sm:text-sm"
                />
              </div>
              <div>
                  ...
                  {reportData.sales && reportData.sales.slice(0, 20).map((sale, idx) => (
                    <div key={idx} className="p-3 rounded-xl border border-gray-200 bg-white">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-sm font-bold text-green-700">{formatCurrency(sale.totalAmount)}</div>
                      </div>
                    </div>
                  ))}
                  {reportData.details && reportData.details.map((day, idx) => (
                    <div key={`d-${idx}`} className="p-3 rounded-xl border border-gray-200 bg-white">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-sm font-bold text-green-700">{formatCurrency(day.totalAmount)}</div>
                      </div>
