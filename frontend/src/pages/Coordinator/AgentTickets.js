          ...
          <div className="p-4 sm:p-5">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center space-x-2">
                  <FunnelIcon className="h-5 w-5 text-green-600 flex-shrink-0" />
                  <h3 className="text-[clamp(13px,2.6vw,16px)] sm:text-[clamp(14px,2.4vw,18px)] font-semibold text-gray-900">Search & Filters</h3>
                </div>
                <button
                  onClick={() => setShowFilters(v => !v)}
                  className="inline-flex items-center px-3 py-1.5 text-xs sm:text-sm font-medium text-green-700 bg-green-100 hover:bg-green-200 rounded-lg transition-colors"
            ...
            <div id="agent-filters-panel">
              ...
              <div className="mb-3 sm:mb-4">
                <div className="relative">
                  <MagnifyingGlassIcon className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-emerald-600" />
                  <input
                    type="text"
                    placeholder="Search by ticket number, agent name, or username..."
                    value={searchTerm}
                    onChange={(e) => handleSearch(e.target.value)}
                    className="w-full pl-10 pr-4 py-2 sm:py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white/50 backdrop-blur-sm transition-all duration-200"
                  />
                </div>
              </div>
              ...
              <div className="sm:col-span-2">
                ...
                <div className="flex items-center space-x-2">
                  <div className="relative flex-1">
                    ...
                    className="w-full pl-9 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white/50 backdrop-blur-sm transition-all duration-200 text-xs sm:text-sm"
                    />
                  </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white/50 backdrop-blur-sm transition-all duration-200 text-xs sm:text-sm"
                >
        ...
        <ModernCard variant="elevated" className="animate-fade-in">
          <div className="p-4 sm:p-5">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <h2 className="font-semibold bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent text-[clamp(14px,2.8vw,18px)]">
                Lottery Tickets
              </h2>
                ...
                <div key={t.id} className="p-3 rounded-xl border border-gray-200 bg-white">
                  ...
                  <div className="mt-3 flex items-center justify-between">
                    <div className="text-sm">
                      ...
                      <div className="font-semibold text-green-700">{formatCurrency(t.totalAmount)}</div>
                    </div>
                    <div className="flex gap-2">
                      {canReprint() ? (
                        <ModernButton variant="ghost" size="sm" onClick={() => handleReprint(t)} icon={PrinterIcon} title="Reprint Ticket" className="text-green-700 hover:text-green-800">Reprint</ModernButton>
                      ) : (
                        <ModernButton variant="ghost" size="sm" onClick={() => handleViewDetails(t)} icon={EyeIcon} className="text-green-700 hover:text-green-800">View</ModernButton>
                      )}
                    </div>
                  </div>
                </div>
