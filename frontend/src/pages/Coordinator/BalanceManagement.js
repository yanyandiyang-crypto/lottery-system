            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
              <div className="relative flex-1 max-w-md">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-4 py-2.5 sm:py-3 border border-gray-300 rounded-xl leading-5 bg-white/50 backdrop-blur-sm placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 text-xs sm:text-sm"
                />
              </div>
                ...
                <div key={row.id} className="p-2 rounded-xl border border-gray-200 bg-white">
                  ...
                  <div className="mt-2 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                    <div className="text-[11px]">
                      ...
                      <div className="text-sm font-semibold text-green-700">{formatCurrency(row.currentBalance)}</div>
                    </div>
