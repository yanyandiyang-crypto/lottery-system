-- Step 2: Add claiming fields (FINAL - with proper JSONB casting)
...
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'audit_log') THEN
        ...
        VALUES (
            1, -- System user
            'MIGRATION_EXECUTED',
            ('{"migration": "005b_add_claiming_fields_final", "description": "Added claiming fields without win_amount references", "timestamp": "' || NOW() || '"}')::jsonb,
            NOW()
        );
    END IF;
END$$;
